...
- `.claude/rules/tests/general/test-case-generation-strategy.md` - INCLUDE/EXCLUDE criteria for test cases
- `.claude/rules/tests/general/naming-conventions.md` - Test naming format
- `.claude/rules/tests/general/general-principles.md` - Core testing principles
- `.claude/rules/tests/general/what-makes-good-test.md` - Clarity, Completeness, Conciseness, Resilience
- `.claude/rules/tests/general/keep-tests-focused.md` - One scenario per test
- `.claude/rules/tests/general/test-behaviors-not-methods.md` - Separate tests for behaviors
- `.claude/rules/tests/general/prefer-public-apis.md` - Test public APIs over private methods
...
**Steps:**
1. **Read the rules** from `.claude/rules/tests/general/` directory
