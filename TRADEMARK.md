...
The MIT License gives you broad rights to the *code and documentation* in this
repository: use it, copy it, modify it, redistribute it, embed it in a
proprietary product, and sell it — provided you retain the copyright notice and
the license text.

None of that requires our permission, and none of it is affected by this policy.

## Permitted Uses of the Marks

You do **not** need permission to:

1. **Refer to the project by name.** Truthful, descriptive references are
   nominative fair use — for example, "built with Unit Test Skills by Mavka AI"
   or "compatible with Mavka AI's testing rules".
2. **Retain the attribution** that ships in `LICENSE`, `AUTHORS`, `CITATION.cff`,
   and this repository's documentation. Keeping these intact is encouraged.
3. **Link to** <https://mavka.ai/> or to this repository.
4. **Cite the project** in articles, talks, courses, and academic work, using
...
1. Use the Marks in the **name of your fork, product, service, or company** — or
   ...
   listing — in a way that suggests it is the official project.
...
## Naming a Fork or Derivative

Forks and derivative works are welcome and fully permitted by the MIT License.
When naming one, distinguish it from the original:

- ✅ "AcmeTest Rules — *based on Unit Test Skills by Mavka AI*"
- ✅ "unit-test-skills-kotlin *(a community fork)*"
- ❌ "Mavka AI Unit Test Skills Pro"
- ❌ "Mavka Testing Suite"

The pattern: describe your relationship to the project in plain prose, but do
not build the Marks into your own product's identity.
